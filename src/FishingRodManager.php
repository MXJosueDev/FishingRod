...
class FishingRodManager {
	...
	/**
	 * Obtain the Fishing Rod custom item. (This only serves for the item to have the custom durability of the
	 * configuration, the other custom properties are integrated even if the item is generated by {@link VanillaItems})
	 *
	 * @return FishingRod
